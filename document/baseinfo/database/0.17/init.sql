...
INSERT INTO `wuyexitong`.`house` (`house_id`,  `house_create_time`, `house_update_time`, `house_user`, `house_check`, `house_can_tax`, `house_intro_tax`) VALUES ('5', now(), now(), '1', '1', '1', '{\"垃圾费\":15.06,\"花草费\":0.15');
...
INSERT INTO `wuyexitong`.`house` (`house_id`, `house_create_time`, `house_update_time`, `house_user`, `house_check`, `house_intro_tax`) VALUES ('2', now(), now(), '2', '1', '{\"垃圾费\":15.06,\"花草费\":0.15');
...
UPDATE `wuyexitong`.`now` SET `now_is_now`='1' WHERE `now_id`='2';
UPDATE `wuyexitong`.`now` SET `now_is_now`='0' WHERE `now_id`='1';
UPDATE `wuyexitong`.`input_house_data` SET `house_area`='122', `house_tax`='122.2', `house_now`='2', `house_cantax_time`='24' WHERE `data_id`='5';
UPDATE `wuyexitong`.`input_house_data` SET `house_area`='96', `house_tax`='96.2', `house_now`='2', `house_cantax_time`='24' WHERE `data_id`='6';
UPDATE `wuyexitong`.`input_house_data` SET `house_area`='64', `house_tax`='78.5', `house_now`='2', `house_cantax_time`='24' WHERE `data_id`='7';
UPDATE `wuyexitong`.`input_house_data` SET `house_area`='123', `house_tax`='123.2', `house_now`='2', `house_cantax_time`='12' WHERE `data_id`='12';
UPDATE `wuyexitong`.`input_house_data` SET `house_area`='56', `house_tax`='50.20', `house_now`='2', `house_cantax_time`='12' WHERE `data_id`='13';
UPDATE `wuyexitong`.`input_house_data` SET `house_area`='86', `house_tax`='88.66', `house_now`='2', `house_cantax_time`='12' WHERE `data_id`='14';
