    ...
    <div class="col-sm-8">
        <div class="panel panel-default">
            <div class="panel-body shadow_div">
                <h2 class="sub-header">用户权限组 | <button class="btn  btn-success"  data-toggle="modal" data-target="#aAdminPowerGroup" type="button">添加权限组</button></h2>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/admin_aUserPowerGroup" method="post">
                 ...
                 @foreach($data as $single)
                        <tr>
                            ...
                            <td><!-- Button trigger modal -->
                                <a href="/admin_moreUserPowerGroup/{{$single -> group_id}}" class="btn btn-info btn-sm">详情</a>
                                ...
                                <div class="modal fade" id="upd_{{$single -> group_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="/admin_uUserPowerGroup" method="post">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <div class="modal fade" id="del_{{$single -> group_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="/admin_dUserPowerGroup/{{$single -> group_id}}" class="btn btn-danger btn-sm">删除</a>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">返回</button>
                                            </div>
                                        </div>
                                    </div>
